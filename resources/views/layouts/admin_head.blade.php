...
<html lang="en" dir="ltr">
 ...
 <head>
  ...
  <title>Dashboard || Premier University - Portal</title>
    ...
    <div class="sidebar-wrapper group w-0 hidden xl:w-[248px] xl:block">
      ...
      <div class="logo-segment">
        ...
        <a class="flex items-center" href="{{route('login.get')}}">
          ...
          {{-- <span class="ltr:ml-3 rtl:mr-3 text-xl font-Inter font-bold text-slate-900 dark:text-white">Premier University</span> --}}
        </a>
        <!-- Sidebar Type Button -->
